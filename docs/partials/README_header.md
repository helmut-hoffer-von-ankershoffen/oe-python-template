...
![Vercel Deploy](https://deploy-badge.vercel.app/vercel/oe-python-template?root=docs)
[![Better Stack Badge](https://uptime.betterstack.com/status-badges/v1/monitor/1vze5.svg)](https://uptime.betterstack.com/?utm_source=status_badge)
