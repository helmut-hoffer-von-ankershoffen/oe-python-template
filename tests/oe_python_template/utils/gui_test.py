...
from oe_python_template.utils._constants import __project_name__
from oe_python_template.utils._gui import (
    BasePageBuilder,
    gui_register_pages,
    gui_run,
)
...
@mock.patch("oe_python_template.utils._gui.locate_subclasses")
...
@mock.patch("oe_python_template.utils._gui.__is_running_in_container__", False)
@mock.patch("oe_python_template.utils._gui.gui_register_pages")
...
@mock.patch("oe_python_template.utils._gui.__is_running_in_container__", True)
@mock.patch("nicegui.ui")
...
def test_gui_run_with_api(
    ...
    Args:
        ...
        mock_register_pages: Mock for gui_register_pages function
    """
    with mock.patch("oe_python_template.api.api") as mock_api:
