...
from oe_python_template.utils import get_logger
from oe_python_template.utils._sentry import (
...
def test_sentry_initialize_with_no_dsn(mock_environment: None) -> None:
    ...
    with mock.patch("oe_python_template.utils._sentry.load_settings") as mock_load_settings:
...
def test_sentry_initialize_with_valid_dsn(mock_environment: None) -> None:
    ...
    with (
        mock.patch("oe_python_template.utils._sentry.load_settings") as mock_load_settings,
